...
public interface UserInfoService extends BaseFrameworkService<UserInfoEntity, Long> {
    ...
    Object updateInviteCode(UserInfoEntity param, HttpServletRequest request, HttpServletResponse response);

    Boolean checkIsCanPay(Long user_id, BigDecimal bigDecimal);
