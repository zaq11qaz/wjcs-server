...
public class tls_sigature {
			...
			String publicKey )
	{
		...
		byte [] compressBytes = base64_url.base64DecodeUrl(urlSig.getBytes(StandardCharsets.UTF_8));
		...
		byte[] signatureBytes = Base64.decode(sigTLS.getBytes(StandardCharsets.UTF_8));
