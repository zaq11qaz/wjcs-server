...
@ApiModel(value="考试项目",description="考试项目属性说明")
public class MechanismExamItemsEntity extends PageInfo {
    private static final long serialVersionUID = -2074239841499459813L;
    /**
     * id
     */
