...
public interface UserCouponService extends BaseFrameworkService<UserCouponEntity, Long> {
    ...
    ResultParam insertUserCoupon177(RechargeRecordEntity rechargeRecordEntity);

    ResultParam insertUserCoupon77(RechargeRecordEntity rechargeRecordEntity);

    ResultParam insertStudyCardByCoup(UserCouponEntity param, HttpServletRequest request, HttpServletResponse response);

    ResultParam insertUserCoupon99(RechargeRecordEntity rechargeRecordEntity);
