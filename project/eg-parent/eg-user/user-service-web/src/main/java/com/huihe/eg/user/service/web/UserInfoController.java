...
public class UserInfoController extends BaseFrameworkController<UserInfoEntity, Long> {
    ...
    public ResultParam updateUserPayPass(@RequestParam Long user_id, @RequestParam String payPassWord, HttpServletRequest request, HttpServletResponse response) {
        UserInfoEntity userInfoEntity = new UserInfoEntity();
        userInfoEntity.setUser_id(user_id);
        userInfoEntity.setPay_pass(MD5Util.GetMD5Code(payPassWord));
        return ResultUtil.success(service.update(userInfoEntity, request, response));
    }
