...
public class UserGroupingController extends BaseFrameworkController<UserGroupingEntity, Long> {
    ...
    public ResultParam updateOnPaymentSettlementCash(UserGroupingEntity userGroupingEntity , HttpServletRequest request , HttpServletResponse response){
        return service.updateOnPaymentSettlementCash(userGroupingEntity,request,response);
    }
